...
包括:
 ...
 源代码修改：
 ::1485  mootools1.2中 内存回收机制的bug
*/


var MooTools = {
    'version': '1.2.1',
    'build': '2008年11月28日19:20:06'
};
...
var Document = new Native({
    ...
    initialize: function(doc){
        ...
        if (Browser.Engine.trident) doc.window.attachEvent('onunload', function() {
            if(doc.window.parent!=doc.window)return;
...
//::1485
var purge = function(){
    //fix Mootools1.21 bug in IE 
    Hash.each(collected, function(){
          try{
           clean.call(clean,$A(arguments));
          }catch(e){}
       });
       /*
    if (Browser.Engine.trident){
      
       $A(document.getElementsByTagName('object')).each(function(){
          try{
           clean.call(clean,$A(arguments));
          }catch(e){}
       });
